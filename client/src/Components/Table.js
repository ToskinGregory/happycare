      ...
      <div className='C-section-header'>
        <div className='C-max-width-lg'>
          <h3 className='C-header-text'>
            HappyCare Product Traceability System
          </h3>
          <p className='C-description-text'>
          A blockchain-powered decentralized system that ensures end-to-end traceability, transparency, and trust across the global food supply chain.
          </p>
        </div>
